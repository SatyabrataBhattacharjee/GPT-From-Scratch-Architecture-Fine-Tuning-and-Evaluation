# GPT-From-Scratch-Architecture-Fine-Tuning-and-Evaluation(FINETUNING AND EVAL IS YET TO BE ADDED)
An end-to-end implementation of a GPT-style Large Language Model built from first principles in PyTorch, covering custom tokenization, attention mechanisms, multi-head transformers, pretrained GPT-2 weight loading, fine-tuning(# PENDING) for downstream tasks, and automated evaluation of instruction-following behavior.
